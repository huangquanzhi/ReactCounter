...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexAction = _interopRequireWildcard(_index);
	...
	var propTypes = {
	    counter: _react.PropTypes.object,
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        actions: (0, _redux.bindActionCreators)(indexAction, dispatch)
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function test() {
	    ...
	    switch (action.type) {
	        case _index.INCREASE_COUNTER:
	            return Object.assign({}, state, { count: state.count + 1 });
	        case _index.DECREASE_COUNTER:
	            return Object.assign({}, state, { count: state.count - 1 });
	        default:
	            return state;
	    }
